...
CONCEPTOS_SRI = {
    ...
    "332": {
        "porcentaje": 0.0,
        "descripcion": "No sujeto a retención / RIMPE Negocio Popular",
    },
    "332B": {"porcentaje": 0.0, "descripcion": "Energía eléctrica (exento)"},
    "332C": {"porcentaje": 0.0, "descripcion": "Transporte público de pasajeros"},
    "332D": {
        "porcentaje": 0.0,
        "descripcion": "Transporte pasajeros/carga internacional",
    },
    "332E": {
        "porcentaje": 0.0,
        "descripcion": "Valores cooperativas transporte a socios",
    },
    ...
    "323E2": {
        "porcentaje": 0.0,
        "descripcion": "Rendimientos financieros: depósito plazo fijo exentos",
    },
    "323N": {
        "porcentaje": 0.0,
        "descripcion": "Rendimientos financieros: títulos renta fija exentos",
    },
    "323O": {
        "porcentaje": 0.0,
        "descripcion": "Intereses a bancos y entidades financieras",
    },
    "323R": {
        "porcentaje": 0.0,
        "descripcion": "Otros intereses y rendimientos exentos",
    },
    "323T": {
        "porcentaje": 0.0,
        "descripcion": "Rendimientos deuda pública ecuatoriana",
    },
    "323U": {
        "porcentaje": 0.0,
        "descripcion": "Rendimientos títulos obligaciones exentos",
    },
    "328": {
        "porcentaje": 0.0,
    ...
    "331": {
        "porcentaje": 0.0,
        "descripcion": "Dividendos en acciones (capitalización)",
    },
    "3250": {"porcentaje": 0.0, "descripcion": "Dividendos exentos"},
    # --- 1% ---
    "310": {
        "porcentaje": 1.0,
        "descripcion": "Transporte privado pasajeros / público y privado carga",
    },
    ...
    "312C": {
        "porcentaje": 1.75,
        "descripcion": "Compras al COMERCIALIZADOR agropecuario",
    },
    # --- 2% ---
    "312": {
        "porcentaje": 2.0,
        "descripcion": "Transferencia de bienes muebles corporales",
    },
    ...
    "319": {
        "porcentaje": 2.0,
        "descripcion": "Arrendamiento mercantil (leasing) - sociedades",
    },
    "334": {
        "porcentaje": 2.0,
        "descripcion": "Enajenación derechos representativos capital",
    },
    "324A": {
        "porcentaje": 2.0,
        "descripcion": "Intereses operaciones crédito entre IFIs",
    },
    ...
    "323B1": {
        "porcentaje": 3.0,
        "descripcion": "Rendimientos: depósitos Cta Ahorros Sociedades",
    },
    "323E": {
        "porcentaje": 3.0,
        "descripcion": "Rendimientos: depósito plazo fijo gravados",
    },
    "323F": {"porcentaje": 3.0, "descripcion": "Rendimientos: operaciones reporto"},
    "323G": {
        "porcentaje": 3.0,
        "descripcion": "Inversiones rendimientos distintos IFIs",
    },
    "323H": {"porcentaje": 3.0, "descripcion": "Rendimientos: obligaciones"},
    "323I": {
        "porcentaje": 3.0,
        "descripcion": "Rendimientos: bonos convertibles acciones",
    },
    "323M": {
        "porcentaje": 3.0,
        "descripcion": "Rendimientos: títulos renta fija gravados",
    },
    "323P": {"porcentaje": 3.0, "descripcion": "Intereses sector público"},
    "323Q": {
        "porcentaje": 3.0,
        "descripcion": "Otros intereses y rendimientos gravados",
    },
    ...
    "303": {
        "porcentaje": 10.0,
        "descripcion": "Honorarios profesionales - personas naturales",
    },
    "304": {
        "porcentaje": 10.0,
        "descripcion": "Servicios prevalece intelecto - personas naturales",
    },
    ...
    "314A": {
        "porcentaje": 10.0,
        "descripcion": "Regalías franquicias - personas naturales",
    },
    "314B": {
        "porcentaje": 10.0,
        "descripcion": "Cánones, derechos autor - personas naturales",
    },
    ...
    "327": {
        "porcentaje": 13.0,
        "descripcion": "Dividendos a personas naturales (12 o 14%)",
    },
    "336": {
        "porcentaje": 0.2,
        "descripcion": "Venta combustibles a comercializadoras (2/mil)",
    },
    "337": {
        "porcentaje": 0.3,
        "descripcion": "Venta combustibles a distribuidores (3/mil)",
    },
    ...
    "346C": {
        "porcentaje": 5.0,
        "descripcion": "Autorretención exportación concentrados",
    },
    "346D": {
        "porcentaje": 5.0,
        "descripcion": "Autorretención comercialización minerales",
    },
    "3481": {
        "porcentaje": 3.0,
        "descripcion": "Autorretenciones Grandes Contribuyentes",
    },
}
...
def aplicar_retencion_renta(df: pl.DataFrame) -> pl.DataFrame:
    ...
    df_modificado = df.filter(
        ...
        pl.lit("SERVICIO_MANO_OBRA").alias("tipo_concepto_ir")
    )
